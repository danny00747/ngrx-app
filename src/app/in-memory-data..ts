  ...
  createDb() {
    const users: User[] = [
      ...
      },
      {
        ...
        username: 'cdietrich',
        email: 'Chelsey_Dietrich@annie.ca',
        address: {
          street: 'Skiles Walks',
          suite: 'Suite 351',
          city: 'Brussels',
      ...
      },
      {
        ...
        username: 'dschulist',
        email: 'Dennis_Schulist@jasper.info',
        address: {
      ...
      {
        id: 8,
        name: 'Nichola Runolfsdottir',
        username: 'nrunolfsdottir',
        email: 'Runolfsdottir@rosamond.me',
        address: {
